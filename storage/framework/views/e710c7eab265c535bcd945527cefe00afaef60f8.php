                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table id="table_roles" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th width="50px"><a class="btn btn-primary btn-xs" href="<?php echo e(url('roles/create')); ?>">Adicionar Rol</a></th>
                                <th>Nombre</th>
                                <th>Descripcion</th>
                            </tr>
                            </thead>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/roles/index.blade.php ENDPATH**/ ?>