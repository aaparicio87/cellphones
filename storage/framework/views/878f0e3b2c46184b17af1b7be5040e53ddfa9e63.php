        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" id="formenviar" action="<?php echo e(url('/celulares/store')); ?>" class="form-horizontal form-label-left input_mask">
                            <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="precio_compra" value="<?php echo e(old('precio_compra')); ?>" id="desc" class="form-control col-md-7 col-xs-12 precio_compra" >
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea class="form-control" name="imei" id="textareaimei" rows="2"><?php echo e(old('imei')); ?></textarea>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/celulares/create.blade.php ENDPATH**/ ?>