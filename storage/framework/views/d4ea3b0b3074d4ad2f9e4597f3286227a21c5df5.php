        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" id="formenviar" action="<?php echo e(url('/ventas/update/'.$venta->id)); ?>" class="form-horizontal form-label-left input_mask">
                            <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="hh:mm" name="hora_venta" id="hora_venta" class="form-control col-md-7 col-xs-12" value="<?php echo e($hora_venta); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="vendedor" id="vendedor" class="form-control col-md-7 col-xs-12 vendedor" value="<?php echo e($venta->vendedor); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/ventas/edit.blade.php ENDPATH**/ ?>