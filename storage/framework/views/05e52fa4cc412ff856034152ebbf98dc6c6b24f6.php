        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" id="formenviar" action="<?php echo e(url('/caja/store')); ?>" class="form-horizontal form-label-left input_mask">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="fecha" id="fecha" class="form-control col-md-7 col-xs-12" value="<?php echo e($fecha_hoy); ?>" readonly>
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="0.00" min="0" step="0.01" name="saldo_dollar" id="saldo_dollar" value="<?php echo e(old('saldo_dollar')); ?>" class="form-control col-md-7 col-xs-12 saldo_dollar">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="0.00" min="0" step="0.01" name="saldo_pesos" value="<?php echo e(old('saldo_pesos')); ?>" id="saldo_pesos" class="form-control col-md-7 col-xs-12 saldo_pesos">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="0.00" min="0" step="0.01" name="saldo_final" value="<?php echo e(old('saldo_final')); ?>" id="saldo_final" class="form-control col-md-7 col-xs-12 saldo_final bold" readonly>
...
<script>
    ...
    jQuery(document).ready(function($){
        ...
        $('#formenviar').submit(function(){
            ...
            if(document.getElementById("saldo_pesos").value<=0){
                document.getElementById("saldo_pesos").value = "0.00";
            }

            if(document.getElementById("saldo_dollar").value<=0){
                document.getElementById("saldo_dollar").value = "0.00";
            }

            if(document.getElementById("saldo_final").value<=0){
                document.getElementById("saldo_final").value = "0.00";
            }
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/caja/create.blade.php ENDPATH**/ ?>