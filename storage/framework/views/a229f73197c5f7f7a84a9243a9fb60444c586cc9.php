...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 divdate">
                                    <input type="text" name="hora_venta" placeholder="hh:mm" value="<?php echo e(old('hora_venta')); ?>" id="hora_venta" class="form-control col-md-7 col-xs-12 hora">
                                    <?php if ($errors->has('hora_venta')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('hora_venta'); ?>
                                    <div class="alert alert-danger"><?php echo e($message); ?></div>
                                    <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>
                                    ...
                                    <select name="imei" id="imei_id" class="form-control col-md-7 col-xs-12 js-example-basic-single">
                                        <?php if($celulares->count()>0): ?>
                                            ...
                                            <?php $__currentLoopData = $celulares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $celular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if($celular->id == old('imei')): ?>
                                                    <option value="<?php echo e($celular->id); ?>" selected><?php echo e($celular->imei); ?></option>
                                                    <?php else: ?>
                                                    <option value="<?php echo e($celular->id); ?>"><?php echo e($celular->imei); ?></option>
                                                    <?php endif; ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="vendedor" id="vendedor" value="<?php echo e(old('vendedor')); ?>" class="form-control col-md-7 col-xs-12 vendedor">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="0.00" step="0.01" value="<?php echo e(old('precio_venta')); ?>" name="precio_venta" id="precio_venta" class="form-control col-md-7 col-xs-12 precio_venta bold" readonly>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/ventas/create.blade.php ENDPATH**/ ?>