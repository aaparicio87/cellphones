        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" action="<?php echo e(url('/celulares/update/'.$celular->id)); ?>" class="form-horizontal form-label-left input_mask">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <select name="marca_id" id="marca_id" class="form-control col-md-7 col-xs-12 js-example-basic-single">
                                        <?php if($marcas->count()>0): ?>
                                            ...
                                            <?php $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($marca->id == $celular->marca_id): ?>
                                    ...
                                    <select name="modelo_id" id="modelo_id" class="form-control col-md-7 col-xs-12 js-example-basic-single">
                                        <?php if($capacidades->count()>0): ?>
                                            ...
                                            <?php $__currentLoopData = $modelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($modelo->id == $celular->modelo_id): ?>
                                                    <option value="<?php echo e($modelo->id); ?>" selected><?php echo e($modelo->desc); ?></option>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            No existen modelos
                                    ...
                                    <select name="color_id" class="form-control col-md-7 col-xs-12 js-example-basic-single">
                                        <?php if($colores->count()>0): ?>
                                            ...
                                            <?php $__currentLoopData = $colores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($color->id == $celular->color_id): ?>
                                    ...
                                    <select name="capacidad_id" class="form-control col-md-7 col-xs-12 js-example-basic-single">
                                        <?php if($capacidades->count()>0): ?>
                                            ...
                                            <?php $__currentLoopData = $capacidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capacidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($capacidad->id == $celular->capacidad_id): ?>
                                    ...
                                    <select name="vendedor" class="form-control col-md-7 col-xs-12 js-example-basic-single">
                                        <?php if($vendedores->count()>0): ?>
                                            ...
                                            <?php $__currentLoopData = $vendedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($vendedor->desc == $celular->vendedor): ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="fecha_compra" id="fecha_compra" class="form-control col-md-7 col-xs-12 date" value="<?php echo e($celular->fecha_compra); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="precio_compra" id="desc" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->precio_compra); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="imei" id="desc" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->imei); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="comprador" id="comprador" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->comprador); ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="fecha_venta" id="fecha_venta" class="form-control col-md-7 col-xs-12 " value="<?php echo e($fecha); ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="precio_venta" id="desc" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->precio_venta); ?>" readonly>
                                </div>
                            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/celulares/edit.blade.php ENDPATH**/ ?>