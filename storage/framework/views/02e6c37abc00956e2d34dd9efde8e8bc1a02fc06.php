                        ...
                        <form method="POST" id="formenviar" action="<?php echo e(url('/cotizacion/store')); ?>" class="form-horizontal form-label-left input_mask">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  placeholder="0.00" step="0.01" name="valor"  value="<?php echo e(old('valor')); ?>" id="valor" class="form-control col-md-7 col-xs-12 valor">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/cotizacion/create.blade.php ENDPATH**/ ?>