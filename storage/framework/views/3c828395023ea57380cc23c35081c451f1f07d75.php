                        ...
                        <form method="POST" action="<?php echo e(url('/usuarios/store')); ?>" class="form-horizontal form-label-left input_mask">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="nombre_usuario" value="<?php echo e(old('nombre_usuario')); ?>" id="nombre_usuario" class="form-control col-md-7 col-xs-12">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="email" value="<?php echo e(old('email')); ?>" id="email" class="form-control col-md-7 col-xs-12">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" name="password" value="<?php echo e(old('password')); ?>" id="password" class="form-control col-md-7 col-xs-12">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alejandro/Documentos/sellphone/resources/views/usuarios/create.blade.php ENDPATH**/ ?>