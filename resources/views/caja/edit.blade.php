        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" id="formenviar" action="{{url('/caja/update/'.$caja->id)}}" class="form-horizontal form-label-left input_mask">
                            @csrf
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Fecha<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="fecha" id="fecha" class="form-control col-md-7 col-xs-12 " value="{{$caja->fecha}}" readonly>
                                </div>
                                @error('fecha')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="0.00" min="0" step="0.01" name="saldo_dollar" id="saldo_dollar" class="form-control col-md-7 col-xs-12 saldo_dollar" value="{{$caja->saldo_dollar}}">
                                    @error('saldo_dollar')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="0.00" min="0" step="0.01" name="saldo_pesos" id="saldo_pesos" class="form-control col-md-7 col-xs-12 precio" value="{{$caja->saldo_pesos}}">
                                    @error('saldo_pesos')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="0.00" min="0" step="0.01" name="saldo_final" id="saldo_final" class="form-control col-md-7 col-xs-12 saldo_final bold" value="{{$caja->saldo_final}}" readonly>
                                @error('saldo_final')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" name="observacion" id="observacion" rows="2">{{$caja->observacion}}</textarea>
