        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" id="formenviar" action="{{url('/ventas/update/'.$venta->id)}}" class="form-horizontal form-label-left input_mask">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="hh:mm" name="hora_venta" id="hora_venta" class="form-control col-md-7 col-xs-12" value="{{$hora_venta}}">
                                    @error('hora_venta')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="vendedor" id="vendedor" class="form-control col-md-7 col-xs-12 vendedor" value="{{$venta->vendedor}}">
                                    @error('vendedor')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
