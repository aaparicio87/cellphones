        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" id="formenviar" action="{{url('/cotizacion/update/'.$cotizacion->id)}}" class="form-horizontal form-label-left input_mask">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  placeholder="0.00" step="0.01" name="valor"  id="valor"  class="form-control col-md-7 col-xs-12" value="{{$cotizacion->valor}}">
                                    @error('valor')
